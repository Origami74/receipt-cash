            ...
            <div>
              ...
              >
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    <p class="text-sm font-medium text-purple-900">Advanced Debug & Recovery</p>
                    <p class="text-xs text-purple-700">Export/import data, view all proofs</p>
                  </div>
                </div>
