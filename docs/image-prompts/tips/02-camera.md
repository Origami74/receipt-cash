# Contextual Tip: Camera

## Context

**When Shown**: First time user sees camera after welcome screens
**Audience**: Hosts
**Purpose**: Explain how to use camera to capture receipt
...
- Paper receipt in frame
- Focus indicators
- Good lighting visualization
- AI/automation symbols (subtle)
