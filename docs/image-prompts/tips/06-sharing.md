...
**Audience**: Hosts
**Purpose**: Explain how to share the receipt with friends
...
- Multiple phones/people scanning
- Flow visualization (scan → select → pay)
- Money flowing back to host
- Friend avatars/icons
